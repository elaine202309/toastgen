    ...
    <footer className="border-t border-blush-dark/20 bg-white/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col gap-4">
          ...
          <div className="text-center text-xs text-charcoal-light/40">
            Powered by DeepSeek. ToastGen is an independent product and is not affiliated with, endorsed by, or connected to DeepSeek.
          </div>
        </div>
      </div>
    </footer>
